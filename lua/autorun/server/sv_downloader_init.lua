...
if #context.addons > 0 then
    print("[DOWNLOADER] SCANNING " .. #context.addons .. " WORKSHOP ADDONS TO ADD RESOURCES...")
    ...
    print("[DOWNLOADER] FINISHED TO ADD RESOURCES: " .. #context.usingAddons .. " WORKSHOP ADDONS SELECTED")
end
